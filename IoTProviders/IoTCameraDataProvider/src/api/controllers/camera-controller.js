...
import * as dngCameraService from '../services/dng-camera-service.js';
import * as googleStorageService from '../services/google-storage-service.js';
...
class CameraControl {
  ...
  listAllCamerasByLocation(req, res) {
   ...
   */
  formURLFromCameraName(cameraName) {
