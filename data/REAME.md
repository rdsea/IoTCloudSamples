...
There are many open datasets that you can download for practicing activities in IoT-Edge-Cloud designs. The following datasets can be used for both batch and streaming analytics and used in different tasks (ingestion, processing, etc.)
